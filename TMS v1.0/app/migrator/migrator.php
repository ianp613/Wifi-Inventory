    ...
    class Migrate{
        ...
        public static function commit(){
            ...
            try{
                ...
                if($e->getCode() == "42S01"){
                    // Table already exists — clean, single-line notice
                    echo "\e[1;33;41mSkipped\e[0m: \e[1;33;40m`".$TABLE."` already exists.\e[0m\n";
                }else{
                    echo "\e[1;33;41mMigration Failed (".$TABLE."):\e[0m \e[1;33;40m".$e->getMessage()."\e[0m\n";
                }
                Migrate::$stat = true;
            }finally{
                // Always reset, whether commit succeeded or failed,
                // so the next migration in the loop starts clean.
                Migrate::$attribute = "";
                Migrate::$table = "";
            }
        }
