...
<head>
    ...
    <title>EVSU PULSE — Sign In</title>
...
<body>
    ...
    <div class="auth-card">
        ...
        <div class="form-head">
            <img src="../../../assets/img/EVSU-PULSE.png" alt="" srcset="">
  
            <p>Sign in to your EVSU PULSE workspace.</p>
        </div>
        ...
        <!-- <div class="divider-row"><span class="line"></span><span>New to EVSU PULSE</span><span class="line"></span></div> -->

        <!-- <div class="switch-cta">Don't have an account? <a href="signup.html">Create one</a></div> -->

        <div class="form-foot">EVSU PULSE — Project Updates, Logging &amp; Scheduling Engine 2026 © Paul Ian</div>
    </div>
